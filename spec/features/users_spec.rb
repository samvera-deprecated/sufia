describe "User Profile", type: :feature do
  ...
  let(:profile_path) { Sufia::Engine.routes.url_helpers.profile_path(user, locale: 'en') }
  ...
  context 'user profile' do
    ...
    let(:dewey_path) { Sufia::Engine.routes.url_helpers.profile_path(dewey, locale: 'en') }
