...
describe Sufia::Works::CurationConcern::Work do
  ...
  it "should mix together all the goodness" do
    [Sufia::Works::CurationConcern::WithGenericFiles, Sufia::Works::CurationConcern::HumanReadableType, Sufia::Works::CurationConcern::WithEditors, Sufia::Noid, Sufia::ModelMethods, Hydra::Collections::Collectible, Solrizer::Common].each do |mixin|
