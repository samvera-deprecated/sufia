...
(function() {
  Mercury.View.Modules.InterfaceFocusable = {
    ...
    preventFocusout: function($constrain) {
      ...
      this.on('release', (function(_this) {
        return function() {
      ...
      $focus.on('blur', (function(_this) {
        return function() {
          return _this.keepFocusConstrained($focus, $constrain);
        };
      })(this));
      $constrain.off('focusout').on('focusout', (function(_this) {
        return function() {
          return _this.keepFocusConstrained($focus, $constrain);
        };
      })(this));
      return $constrain.on('keydown', (function(_this) {
        return function(e) {
    ...
    keepFocusConstrained: function($focus, $constrain) {
      return this.preventFocusoutTimeout = this.delay(1, (function(_this) {
        return function() {
...
(function() {
  ...
  Mercury.Snippet = (function(_super) {
    ...
    Snippet.prototype.displayForm = function(form) {
      ...
      return view.on('form:success', (function(_this) {
        return function() {
          return _this.render();
        };
      })(this));
  ...
  Mercury.Region = (function(_super) {
    ...
    Region.prototype.pushHistory = function(keyCode) {
      ...
      if (pushNow) {
        ...
        return this.historyTimeout = this.delay(2500, (function(_this) {
          return function() {
...
(function() {
  Mercury.View.Modules.Draggable = {
    ...
    bindDocumentDragEvents: function(el) {
      return $(el).on('mousemove', this.onDragHandler = (function(_this) {
        return function(e) {
          return _this.onDrag(e);
        };
      })(this)).on('mouseup', this.onEndDraggingHandler = (function(_this) {
        return function(e) {
...
(function() {
  ...
  Mercury.Model.Page = (function(_super) {
    ...
    Page.prototype.createRegions = function(elements) {
      var el, _i, _len;
      for (_i = 0, _len = elements.length; _i < _len; _i++) {
        el = elements[_i];
    ...
    Page.prototype.createRegion = function(el) {
      if ($(el).data('region')) {
        return;
      }
      return this.regions.push(Mercury.Region.create(el));
    };

    Page.prototype.loadRegionContent = function(json) {
    ...
    Page.prototype.findRegionByName = function(name) {
    ...
    Page.prototype.hasChanges = function() {
      var region, _i, _len, _ref;
      _ref = this.regions;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        region = _ref[_i];
    ...
    Page.prototype.isValid = function() {
      ...
      return Page.__super__.isValid.apply(this, arguments);
    };
...
(function() {
  Mercury.View.Modules.InterfacePageManager = {
    included: function() {
      return this.on('build', this.initInterfaceManager);
    },
    initInterfaceManager: function() {
      this.initPage();
      this.on('release', this.releasePage);
      return this.delegateEvents({
        'mercury:save': 'save',
    ...
    load: function(json) {
      return this.page.loadRegionContent(json);
    },
...
(function() {
  ...
  Mercury.BaseInterface = (function(_super) {
    ...
    BaseInterface.include(Mercury.View.Modules.InterfacePageManager);
    ...
    BaseInterface.prototype.position = function(animate) {
      ...
      this.width = width = Math.max(this.config('interface:floatWidth') || this.page.region.$el.width(), 300);
    ...
    BaseInterface.prototype.positionForRegion = function() {
      return this.page.region.$el.offset();
    };
    ...
    BaseInterface.prototype.onUnload = function() {
      if (this.config('interface:silent') || !this.page.hasChanges()) {
        return;
      }
...
(function() {
  ...
  Mercury.FrameInterface = (function(_super) {
    ...
    FrameInterface.prototype.frameLocation = function() {
      var _ref, _ref1;
      return (_ref = this.$frame.get(0)) != null ? (_ref1 = _ref.contentWindow) != null ? _ref1.location.href : void 0 : void 0;
    };
    ...
    FrameInterface.prototype.hijackLinksAndForms = function() {
      var $el, classname, el, ignored, nonHijackableClasses, regionSelector, _i, _j, _len, _len1, _ref, _results;
      nonHijackableClasses = this.config('interface:nohijack') || [];
      regionSelector = "[" + (this.config('regions:attribute')) + "]";
      _ref = $('a, form', this.document);
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        el = _ref[_i];
        $el = $(el);
...
(function() {
  ...
  Mercury.Statusbar = (function(_super) {
    ...
    Statusbar.prototype.show = function() {
      ...
      this.visible = true;
      this.$el.show();
      return this.visibilityTimeout = this.delay(50, (function(_this) {
        return function() {
          return _this.css({
            bottom: 0
          });
    ...
    Statusbar.prototype.hide = function() {
      ...
      return this.visibilityTimeout = this.delay(250, (function(_this) {
        return function() {
...
(function() {
  ...
  Mercury.ToolbarButton = (function(_super) {
    ...
    ToolbarButton.prototype.buildSubview = function() {
      var Klass, options;
      if (this.subview) {
        this.subview.on('show', (function(_this) {
          return function() {
            if (_this.toggle) {
              _this.toggled();
            }
        ...
        this.subview.on('hide', (function(_this) {
          return function() {
            _this.untoggled();
    ...
    ToolbarButton.prototype.onRegionFocus = function(region) {
      return this.delay(100, (function(_this) {
        return function() {
...
(function() {
  ...
  Mercury.Uploader = (function(_super) {
    ...
    Uploader.prototype.show = function() {
      ...
      return this.delay(50, (function(_this) {
        return function() {
          return _this.css({
            opacity: 1
          });
...
(function() {
  Mercury.Region.Modules.Snippetable = {
    ...
    loadSnippet: function(cid, data) {
      return Mercury.Snippet.fromSerializedJSON(data).renderAndReplaceWithView(this.$("[data-mercury-snippet=" + cid + "]"), (function(_this) {
        return function() {
          try {
...
(function() {
  ...
  Plugin = Mercury.registerPlugin('blocks', {
    ...
    bindTo: function(view) {
      return view.on('block:picked', (function(_this) {
...
(function() {
  ...
  Plugin = Mercury.registerPlugin('character', {
    ...
    bindTo: function(view) {
      return view.on('character:picked', (function(_this) {
...
(function() {
  ...
  Plugin = Mercury.registerPlugin('color', {
    ...
    bindTo: function(view) {
      return view.on('color:picked', (function(_this) {
        return function(value) {
...
(function() {
  ...
  Plugin = Mercury.registerPlugin('link', {
    ...
    bindTo: function(view) {
      return view.on('form:submitted', (function(_this) {
        return function(value) {
          return _this.triggerAction(value);
        };
      })(this));
...
(function() {
  ...
  Plugin = Mercury.registerPlugin('snippets', {
    ...
    bindTo: function(view) {
      return view.on('insert:snippet', (function(_this) {
        return function(value) {
          return _this.triggerAction(value);
        };
      })(this));
...
(function() {
  ...
  Plugin = Mercury.registerPlugin('styles', {
    ...
    bindTo: function(view) {
      return view.on('style:picked', (function(_this) {
        return function(value) {
          return _this.triggerAction(value);
        };
      })(this));
